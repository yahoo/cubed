...
create temporary table sketch_intermediate(state string,logged_in string, step string, sketch binary);
insert into sketch_intermediate select state,logged_in, 'step1', unionSketches(sketch, 262144) from theta_input where step >= 1 group by state,logged_in;
insert into sketch_intermediate select state,logged_in, 'step2', unionSketches(sketch, 262144) from theta_input where step >= 2 group by state,logged_in;
insert into sketch_intermediate select state,logged_in, 'step3', unionSketches(sketch, 262144) from theta_input where step >= 3 group by state,logged_in;
insert into sketch_intermediate select state,logged_in, 'step4', unionSketches(sketch, 262144) from theta_input where step >= 4 group by state,logged_in;
