...
/**
 * Test bundle properties XML generation.
 */
public class BundlePropertiesXmlTest {
    BundlePropertiesXml tg;
    ...
    public void testGeneratePropertiesXmlTemplate() throws Exception {
        ...
        String expected = TemplateTestUtils.loadTemplateInstance("templates/bundle_properties.xml");
